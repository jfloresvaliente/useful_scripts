...
# DEPA <- shapefile('C:/Users/jflores/Documents/JORGE/colaboradores/PeruMaps/departamentos/DEPARTAMENTOS.shp')
# PROV <- shapefile('C:/Users/jflores/Documents/JORGE/colaboradores/PeruMaps/provincias/PROVINCIAS.shp')
# DIST <- shapefile('C:/Users/jflores/Documents/JORGE/colaboradores/PeruMaps/distritos/DISTRITOS.shp')

#-------- COMIENZO ELEGIR DISTRITOS--------#
idD <- grep(pattern = 'salas', x = DIST$DISTRITO, ignore.case = T)
DIST$DISTRITO[idD]
idD
